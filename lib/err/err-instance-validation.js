 ...
 * @class
 */
function ErrInstanceValidation(objectUnderTest) {
  // out = Object Under Test
  this.out = objectUnderTest;
}

ErrInstanceValidation.prototype._validate_ = function (configPath, verification, message) {
 ...
 */
ErrInstanceValidation.prototype.shouldBeDefined = function (configPath, message) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeUndefined = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeNonEmptyArray = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeArray = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldBeArray(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeArray = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeObject = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeObject = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeEmpty = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeEmpty = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldNotBeEmpty(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeFunction = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeFunction = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeString = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeString = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeNumber = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeNumber = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeFinite = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeInfinite = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeBoolean = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeBoolean = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeDate = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeDate = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeRegExp = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeRegExp = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeFalsey = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeFalsey = function (configPath, message) {
  this._validate_(configPath, function (val) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeFalsy = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldBeFalsey(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeFalsy = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldNotBeFalsey(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldBeTruthy = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldNotBeFalsey(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.shouldNotBeTruthy = function (configPath, message) {
  this._validate_(configPath, function (val) {
    errValidation.shouldBeFalsey(val, message);
  }, message);
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.checkArgument = function (expression, message) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.checkState = function (expression, message) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.checkElementIndex = function (index, size, message) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.checkPositionIndex = function (index, size, message) {
 ...
 * @returns {this} - Returns itself to allow chainable validations.
 */
ErrInstanceValidation.prototype.checkPositionIndexes = function (start, end, size, message) {
  errValidation.checkPositionIndexes(start, end, size, message);
  return this;
};

module.exports = ErrInstanceValidation;
